...
if ($reportType === 'daily' && !empty($_GET['class_id']) && !empty($_GET['date'])) {
...
} elseif ($reportType === 'student' && !empty($_GET['student_number'])) {
    // Convert student number to student ID
    ...
    if ($student) {
        ...
        $reportData = ['success' => false, 'message' => 'Student not found with number: ' . $studentNumber];
    }
                ...
                <form method="GET" action="">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_number" class="form-control" placeholder="Enter student number (e.g., 2021-001)" value="<?php echo $_GET['student_number'] ?? ''; ?>" required>
                        </div>
                        <div class="form-group">
                                ...
                                <tbody>
                                    <?php foreach ($reportData['data']['classes'] as $class): ?>
                                        <tr>
                                            ...
                                            <td><strong><?php echo number_format((float)$class['attendance_percentage'], 2); ?>%</strong></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
