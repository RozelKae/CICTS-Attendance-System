...
<aside class="sidebar">
    <div class="sidebar-header">
        ...
        <p><?php echo htmlspecialchars($_SESSION['identifier'] ?? 'Secretary'); ?></p>
        <p class="user-role">Secretary / Admin</p>
    </div>
    
    <nav class="nav-menu">
        <a href="secretary_dashboard.php" class="<?php echo $currentPage == 'secretary_dashboard.php' ? 'active' : ''; ?>">
            📊 Dashboard
        </a>
        <a href="secretary_students.php" class="<?php echo $currentPage == 'secretary_students.php' ? 'active' : ''; ?>">
            👥 Student Management
        </a>
        ...
        <a href="secretary_reports.php" class="<?php echo $currentPage == 'secretary_reports.php' ? 'active' : ''; ?>">
            📈 Reports
        </a>
